...
namespace VF_API.Migrations
{
    ...
    [Migration("20170814055718_add converstation again")]
    partial class addconverstationagain
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("VF_API.Models.FavoriteProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VF_API.Models.ProductAttender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VF_API.Models.ReviewProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VF_API.Models.FavoriteProduct", b =>
                {
                    b.HasOne("VF_API.Models.ApplicationUser", "User")
                        .WithMany("FavoriteProduct")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("VF_API.Models.Product", "Product")
                        .WithMany()
