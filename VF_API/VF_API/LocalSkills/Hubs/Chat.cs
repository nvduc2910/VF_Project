...
namespace VF_API.Hubs
{
    ...
    public class Chat : Hub
    {
        ...
        private LocalSkillDBContext dataContext = null;

        protected LocalSkillDBContext DataContext
        {
            get {
                ...
                {
                    var options = new DbContextOptionsBuilder<LocalSkillDBContext>();
                    ...
                    dataContext =  new LocalSkillDBContext(options.Options);
                    return dataContext;
                }
        ...
        public Chat( IHttpContextAccessor contextAccessor,
            IUnitOfWork unitOfWork, LocalSkillDBContext context )
        {
